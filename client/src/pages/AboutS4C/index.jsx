...
class AboutS4C extends Component {
        ...
        return(
          <div className="mainContain">
            ...
            <div className="grid-container">
              ...
              <div className="box-shadow" id="main-wedo">
              ...
              <div className="box-shadow" id="main-mission">
              ...
              <div className="box-shadow" id="goal-panel">
